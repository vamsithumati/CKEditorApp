        ...
        $(document).ready(function () {
            $("#CKEditorButton").click(function () {
                ...
                $("#CKEditorButton").hide();
                $("#CKEditorSubmitButton").hide();
            });
            $('#refreshData').click(()=>{
                    CKEDITOR.instances['CKEditorInputTag'].destroy();
                    var temp = $('#CKEditorInputTag1').html();
                    $('#CKEditorInputTag1').html('');
                    console.log('script')
            })
        });
        ...
        function openEditor(inputTag,inputdata) {
            if (typeof CKEDITOR.instances['CKEditorInputTag'] == 'undefined') {
                ...
                var editor = CKEDITOR.replace('CKEditorInputTag', { extraPlugins: 'abbr,closeEditor', dialog: 'AADialog', allowedContent: true, dialog_noConfirmCancel: true });
                showButtonLabels();
